...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', OPTIONS_FRAMEWORK_DIRECTORY . 'options-framework.css', array(), Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_DIRECTORY . 'options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
